<?php
namespace PanadeEdu\Plugin\Blog\Controller;
...
class PostController extends ActionController {
	...
	/**
	 * @Flow\Inject
	 * @var \PanadeEdu\Plugin\Blog\Service\ContentService
	 */
	...
	public function indexAction() {
		...
		if ($blogDocumentNode !== NULL) {
			...
			$this->view->assign('hasPostNodes', $blogDocumentNode->hasChildNodes('PanadeEdu.Plugin.Blog:Post'));
		} else {
	...
	public function rssAction() {
		...
		foreach ($blogDocumentNode->getChildNodes('PanadeEdu.Plugin.Blog:Post') as $postNode) {
...
#			$item->setCategories(array('test'));
	...
	public function createAction() {
		...
		$nodeTemplate->setNodeType($this->nodeTypeManager->getNodeType('PanadeEdu.Plugin.Blog:Post'));
